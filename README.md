...
3. Techniques to handle Class Imbalanced
...
Balancing class in datasets is super important because imbalance can lead to inaccurate results. In Machine Learning, we always aim to make our predictions accurate. If we have imbalanced dataset, our model will be more biased towards the class with dominancy in our dataset.
